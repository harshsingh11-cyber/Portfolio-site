...
import IMG5 from '../imagess/pro-6.png';
import './Project.css';
...
const data = [
  ...
  },
  {
    ...
    demo:'https://harshsingh11-cyber.github.io/DramSet-master/'
  },
  {
    id:5,
    image: IMG4,
  ...
  },
  {
    id:6,
    image: IMG5,
    title:'Weather -(Live + 4 days Forecast)',
    github:'https://github.com/harshsingh11-cyber/new-weather',
    demo:'https://profound-starlight-d0d572.netlify.app/'
  }
]
function Project() {
  return (
